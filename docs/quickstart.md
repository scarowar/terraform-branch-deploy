...
Normal apply uses the latest successful saved plan for the same environment and commit. The restored plan artifact name and saved metadata must agree before Terraform runs. It must not run a fresh untargeted Terraform apply.
